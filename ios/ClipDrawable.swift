...
import UIKit
class ClipDrawable: CAShapeLayer {
    ...
    @discardableResult
     func setD(_ v:String) -> ClipDrawable{
        mD = v
        invalidate()
       return self
    }
    ...
    @discardableResult
     func setViewBox(_ v:[CGFloat]) -> ClipDrawable{
    ...
    @discardableResult
     func setAspect(_ v:SVGViewBox.AspectRatio) -> ClipDrawable{
        if mAspect != v{
            mAspect = v
            invalidate()
        }
    ...
    @discardableResult
     func setAlign(_ v:String) -> ClipDrawable{
        if mAlign != v{
            mAlign = v
            invalidate()
        }
    ...
    @discardableResult
    func setOpacity(_ v:Float) -> ClipDrawable{
        if mProps.opacity != v{
            mProps.opacity = v
    ...
    @discardableResult
     func setFill(_ v:Int) -> ClipDrawable{
    ...
    @discardableResult
     func setFillRule(_ v:String) -> ClipDrawable{
    ...
    @discardableResult
     func setFillOpacity(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setStroke(_ v:Int) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeOpacity(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeWidth(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeCap(_ v:String) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeJoin(_ v:String) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeMiter(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeStart(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setStrokeEnd(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setShadow(_ v:Int) -> ClipDrawable{
    ...
    @discardableResult
     func setShadowOpacity(_ v:Float) -> ClipDrawable{
    ...
    @discardableResult
     func setShadowRadius(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setShadowOffset(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setShadowOffsetX(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setShadowOffsetY(_ v:CGFloat) -> ClipDrawable{
    ...
    @discardableResult
     func setShadowPercentageValue(_ v:Bool) -> ClipDrawable{
