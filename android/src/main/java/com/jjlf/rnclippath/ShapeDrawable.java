...
private float mBgBlurRadius = 0f;
        ...
        ShapeDrawable setBlur(float radius)  {
        mBlurRadius = radius;
        mBorderBlurRadius = radius;
        mBgBlurRadius = radius;
        return this;
        }
        ShapeDrawable setBackgroundBlur(float radius)  {
        mBgBlurRadius = radius;
        return this;
        }
        ShapeDrawable setFillBlur(float radius)  {
        mBlurRadius = radius;
        return this;
        }
        ShapeDrawable setBorderBlur(float radius)  {
        mBorderBlurRadius = radius;
        return this;
        }

        //MARK: Path set and get
        ShapeDrawable setPathScale(float sx,float sy)  {
        mPathScaleX = sx;
        mPathScaleY = sy;
        return this;
        }

        ShapeDrawable setPathRotation(float degrees)  {
        mPathRotation = degrees;
        return this;
        }
        //pixels
        ShapeDrawable setPathTranslation(float dx,float dy)  {
        ...
        ShapeDrawable setPathTranslation(float percentX,float percentY, float plusX, float plusY)  {
        ...
        ShapeDrawable setShadowOffset(float x,float y ,boolean percent)   {
        mShadowOffsetX = x;
        mShadowOffsetY = y;
        ...
        ShapeDrawable setShadowRadius(float r)  {
        mShadowRadius = r;
        return this;
        }

        ShapeDrawable setShadowOpacity(float o)   {
        mShadowOpacity = ModUtil.clamp(o);
        return this;
        }

        ShapeDrawable setShadowColor(int c)   {
        mShadowColor = c;
        return this;
        }

        //MARK: STROKE SET
        ShapeDrawable setStrokeWidth(float w)  {
        mPaint.setStrokeWidth(w);
        mPaintStroke.setStrokeWidth(w);
        return this;
        }

        ShapeDrawable setStrokeColor(int color)  {
        mPaintStroke.setColor(color);
        return this;
        }
        ShapeDrawable setStrokeStart(float s){
        mStrokeStart = ModUtil.clamp(s);
        return this;
        }

        ShapeDrawable setStrokeEnd(float e)  {
        mStrokeEnd =  ModUtil.clamp(e);
        return this;
        }
        ShapeDrawable setStrokeCap(Paint.Cap cap)   {
        mPaintStroke.setStrokeCap(cap);
        return this;
        }
        ShapeDrawable setStrokeMiter(float miter) {
        mPaintStroke.setStrokeMiter(miter);
        return this;
        }
        ShapeDrawable setStrokeJoin(Paint.Join join)  {
        ...
        ShapeDrawable setSvgPath(String d,float density,float[] viewBox,String align,int aspect)  {
        mSvgPath = d;
        mSvgAlign = align;
        mSvgAspect = aspect;
        mDensity = density;
        ...
        ShapeDrawable setShape(int s)   {
        mShape = s;
        return this;
        }

        ShapeDrawable setRadius(float v)  {
        mRadius = new float[]{v,v,v,v,v,v,v,v};
        return this;
        }

        ShapeDrawable setRadius(float topLeft,float topRight,float bottomLeft,float bottomRight)   {
        mRadius = new float[]{topLeft,topLeft,topRight,topRight,bottomRight,bottomRight,bottomLeft,bottomLeft};
        return this;
        }

        ShapeDrawable setFillColor(int c)  {
        mPaint.setColor(c);
        return this;
        }

        ShapeDrawable setBackgroundColor(int c){
        mPaintBg.setColor(c);
        return this;
        }
        ShapeDrawable setInset(float dx,float dy){
        mInsetX = dx;
        mInsetY = dy;
        return this;
        }
        ...
        ShapeDrawable setScale(float sx,float sy) {
        mScaleX = sx;
        mScaleY = sy;
        return this;
        }

        ShapeDrawable setRotationZ(float degrees)  {
        mRotationZ = degrees;

        return this;
        }
        ShapeDrawable setRotationX(float degrees) {
        mRotationX = degrees;
        return this;
        }
        ShapeDrawable setRotationY(float degrees)  {
        mRotationY = degrees;
        return this;
        }
        ShapeDrawable setRotationOrder(int f,int s,int t)  {
        ...
        //pixels
        ShapeDrawable setTranslation(float dx,float dy)  {
        ...
        ShapeDrawable setTranslation(float percentX,float percentY,float plusX,float plusY)  {
...
private boolean mIsBoundsPercentSize = false;
        ShapeDrawable setBoundsDynamically(float x,float y,float width,float height,boolean percentPos, boolean percentSize)  {
...
private RectF mBlurRect = new RectF();
